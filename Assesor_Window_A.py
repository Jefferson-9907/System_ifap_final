...
class Assesor:
    def __init__(self, root):
        ...
        self.e_cedula.bind('<Return>', self.sig_entry)
        ...
        self.e_nombres.bind('<Return>', self.sig_entry1)
        ...
        self.e_apellidos.bind('<Return>', self.sig_entry2)
        ...
        self.e_direccion.bind('<Return>', self.sig_entry3)
        ...
        self.e_correo.bind('<Return>', self.sig_entry4)
    ...
    def sig_entry4(self, event):
        if self.e_correo.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: CORREO!!!")
            self.e_correo.focus()
