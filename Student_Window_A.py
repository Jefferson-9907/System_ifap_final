...
from tkinter import Checkbutton as tk
import random
...
class Student:
    ...
    def __init__(self, root):
        ...
        self.e_representante_al_1.set("S/R")
        self.e_n_c_representante_al_1.set("S/R")
        ...
        self.e_cedula_al.bind('<Return>', self.sig_entry)
        ...
        self.e_nombres_al.bind('<Return>', self.sig_entry1)
        ...
        self.e_apellidos_al.bind('<Return>', self.sig_entry2)
        ...
        self.e_edad_al.bind('<Return>', self.sig_entry3)
        ...
        self.e_direccion_al.bind('<Return>', self.sig_entry4)
        ...
        self.e_correo_al.bind('<Return>', self.sig_entry5)
        ...
        self.e_celular_al.bind('<Return>', self.sig_entry6)
        ...
        self.e_telefono_al.bind('<Return>', self.sig_entry7)
        ...
        self.check1 = tkinter.Checkbutton(Manage_Frame, variable=self.seleccion, command=self.cambiarestado)
        self.check1.grid(column=1, row=9, padx=1, pady=5, sticky="W")

        self.l_representante_al = Label(Manage_Frame, text='NOMBRE REPR.', width='15',
                                        font=('Copperplate Gothic Bold', 10), bg='#808080')
        self.l_representante_al.grid(column=0, row=10, padx=1, pady=5)
        ...
        self.e_representante_al.grid(column=1, row=10, padx=1, pady=5, sticky="W")

        self.l_n_c_representante_al = Label(Manage_Frame, text='No. CÉDULA REPR.', width='15',
                                            font=('Copperplate Gothic Bold', 10), bg='#808080')
        self.l_n_c_representante_al.grid(column=0, row=11, padx=1, pady=5)
    ...
    def sig_entry(self, event):
        if self.e_cedula_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: No. CÉDULA!!!")
            self.e_cedula_al.focus()

        else:
            self.e_nombres_al.focus()

    def sig_entry1(self, event):
        if self.e_nombres_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_nombres_al.focus()

        else:
            self.e_apellidos_al.focus()

    def sig_entry2(self, event):
        if self.e_apellidos_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_apellidos_al.focus()

        else:
            self.e_edad_al.focus()

    def sig_entry3(self, event):
        if self.e_edad_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_edad_al.focus()

        else:
            self.e_direccion_al.focus()

    def sig_entry4(self, event):
        if self.e_direccion_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_direccion_al.focus()

        else:
            self.e_correo_al.focus()

    def sig_entry5(self, event):
        if self.e_correo_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_correo_al.focus()

        else:
            self.e_celular_al.focus()

    def sig_entry6(self, event):
        if self.e_celular_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_celular_al.focus()

        else:
            self.e_telefono_al.focus()

    def sig_entry7(self, event):
        if self.e_telefono_al.get() == '':
            messagebox.showwarning("SYST_CONTROL(IFAP®)-->(ADVERTENCIA)", "INGRESE EL CAMPO: NOMBRES DEL ESTUDIANTE!!!")
            self.e_telefono_al.focus()
    ...
    def cambiarestado(self):
        if self.seleccion.get() == 1:
            ...
            self.e_representante_al.configure(state='normal')
            self.e_n_c_representante_al_1.set("")
            self.e_n_c_representante_al.configure(state='normal')
